...
public class XOTabla {
    ...
    public void setInputXO(String inputIgraca){
    ...
    public void odigrajPotez (int izabranoPolje) {
        if (izabranoPolje == 1) {
            this.polje1 = this.inputXO;

        } else if (izabranoPolje == 2) {
            this.polje2 = this.inputXO;

        } else if (izabranoPolje == 3) {
            this.polje3 = this.inputXO;

        } else if (izabranoPolje == 4) {
            this.polje4 = this.inputXO;

        } else if (izabranoPolje == 5) {
            this.polje5 = this.inputXO;

        } else if (izabranoPolje == 6) {
            this.polje6 = this.inputXO;

        } else if (izabranoPolje == 7) {
            this.polje7 = this.inputXO;

        } else if (izabranoPolje == 8) {
            this.polje8 = this.inputXO;
